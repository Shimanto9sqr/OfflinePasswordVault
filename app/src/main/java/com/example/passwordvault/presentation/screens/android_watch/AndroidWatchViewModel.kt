...
import com.example.passwordvault.presentation.screens.android_watch.event.AndroidWatchUiEffect
import com.example.passwordvault.presentation.screens.android_watch.event.AndroidWatchUiEvent
...
class AndroidWatchViewModel @Inject constructor(
    ...
    private suspend fun setupPin(): AndroidWatchUiEffect? {
        return if (state.pin.isEmpty()) {
            ...
            val pin = state.pin
            state = state.copy(hasAndroidWatchPinSet = true, pin = "")
