...
import com.example.passwordvault.presentation.screens.pin.event.PinUiEffect
import com.example.passwordvault.presentation.screens.pin.event.PinUiEvent
...
class PinViewModel @Inject constructor(
    ...
    private suspend fun disablePin() {
        userPreferencesRepository.setPin("")
    ...
    private suspend fun changePin(): PinUiEffect? {
        if (state.pin.isEmpty()) {
            ...
            state = state.copy(usePin = true, hasPinSet = true, pin = "")
