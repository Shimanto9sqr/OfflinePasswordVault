...
import com.example.passwordvault.domain.model.orderBy
import com.example.passwordvault.domain.model.where
...
class HomeViewModel @Inject constructor(
    ...
    private fun onClearSearch(): HomeUiEffect {
        state = state.copy(searchQuery = "", isSearching = false, filteredItems = null)
